...
const Organizations = () => {
  ...
  return (
    <section ref={scrollRef} className="py-32 px-6 bg-white overflow-hidden">
      <div className="max-w-[1440px] mx-auto">
        <div className="text-center mb-24">
          <h2 className="text-[44px] md:text-[56px] font-extrabold mb-6">Serving Complex Organizations</h2>
